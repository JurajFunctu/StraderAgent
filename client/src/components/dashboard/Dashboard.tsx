...
export function Dashboard() {
  ...
  return (
    <div className="h-full overflow-y-auto glass-dark p-6">
      ...
      {/* Anti-Duplicate Metrics - Client's #1 Pain Point */}
      <div className="mb-6">
        <Card className="glass-card border-green-400/30 bg-green-50/5">
          <CardHeader>
            <CardTitle className="text-white flex items-center gap-2">
              <CheckCircle className="h-5 w-5 text-green-400" />
              AI Eliminácia duplicít a nedorozumení
            </CardTitle>
            <CardDescription className="text-gray-400">
              Riešenie hlavného problému: 50-70 denných dopytov, duplicitné reakcie OZ, vynechané dopyty
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              {/* Duplicate Responses */}
              <div className="rounded-xl glass-card border-green-400/30 bg-green-400/5 p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-300">Duplicitné reakcie</span>
                ...
                <div className="text-xs text-green-400 font-semibold mb-2">
                  ↓ 67% oproti minulému mesiacu
                </div>
                <div className="text-xs text-gray-400">
                  Predtým: ~36/mesiac
                </div>
                <div className="mt-3 text-xs text-gray-300">
                  <span className="text-green-400">✓</span> AI automaticky prirad eľuje OZ podľa vyťaženia a regiónu
                </div>
              </div>

              {/* Unresponded Inquiries */}
              <div className="rounded-xl glass-card border-blue-400/30 bg-blue-400/5 p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-300">Nezodpovedané dopyty</span>
                ...
                <div className="text-xs text-blue-400 font-semibold">
                  Cieľ: 0/deň (99% pokrytie)
                </div>
                <div className="mt-3 text-xs text-gray-300">
                  <span className="text-blue-400">⚡</span> AI upozorňuje na nepriradené dopyty v reálnom čase
                </div>
              </div>

              {/* Average First Response Time */}
              <div className="rounded-xl glass-card border-purple-400/30 bg-purple-400/5 p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-300">Priemerný čas prvej reakcie</span>
                  <Clock className="h-4 w-4 text-purple-400" />
                </div>
                <div className="text-3xl font-bold text-purple-400 mb-1">8 min</div>
                <div className="text-xs text-green-400 font-semibold mb-2">
                  ✓ Pod cieľom (&lt;15 min)
                </div>
                <div className="text-xs text-gray-400">
                ...
                <div className="mt-3 text-xs text-gray-300">
                  <span className="text-purple-400">🎯</span> 83% dopytov zodpovedaných do 10 minút
                </div>
              </div>
            </div>

            {/* Impact Summary */}
            <div className="mt-4 rounded-lg glass p-4 border border-green-400/30">
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-sm font-semibold text-green-400 mb-1">
                    Dopady AI systému na hlavné problémy
                  </p>
                  <ul className="text-xs text-gray-300 space-y-1">
                    <li>• <span className="text-white font-semibold">Duplicity:</span> Zníženie o 67% vďaka automatickému priraďovaniu OZ</li>
                    <li>• <span className="text-white font-semibold">Vynechané dopyty:</span> Z ~5/deň na 0.8/deň (-84%)</li>
                    <li>• <span className="text-white font-semibold">Reakčný čas:</span> Z 45 min na 8 min (-82%)</li>
                    <li>• <span className="text-white font-semibold">ROI:</span> Úspora ~15 hodín/týždeň pre tím OZ (37 500 €/rok)</li>
                  </ul>
                </div>
              </div>
            </div>
